...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inicializa la tabla de clubes usando DataTables
    tableClubes = $('#tableClubes').dataTable({
        ...
        "ajax": {
            "url": base_url + "/Clubes/getClubes", // URL para obtener los datos de los clubes
            "dataSrc": "data"               // El array de datos se encuentra directamente en la raíz
        },
        "columns": [
            {"data": "id"},             // ID del club
