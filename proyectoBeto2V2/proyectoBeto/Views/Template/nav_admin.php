...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
      ...
      <ul class="treeview-menu">
        <li>
          <a class="treeview-item" href="<?= base_url(); ?>/jugadores">
            <i class="icon fa fa-circle-o"></i> Jugadores
          </a>
        </li>
        <li>
          <a class="treeview-item" href="<?= base_url(); ?>/jugadores/jugadoresLibres">
            <i class="icon fa fa-circle-o"></i> Jugadores Libres
          </a>
        </li>
        <!-- <li>
    ...
    <!-- Modulo Clubes -->
      ...
      <a class="app-menu__item" href="#" data-toggle="treeview">
        <i class="app-menu__icon fa fa-futbol-o" aria-hidden="true"></i>
        <span class="app-menu__label">Clubes</span>
        <i class="treeview-indicator fa fa-angle-right"></i>
      </a>
      <ul class="treeview-menu">
        <li>
        ...
        <li>
          <a class="treeview-item" href="<?= base_url(); ?>/clubes/clubesLibres">
            <i class="icon fa fa-circle-o"></i> Clubes Libres
          </a>
        </li>
      </ul>
    </li>
